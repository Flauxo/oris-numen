            ...
            try {
                ...
                if (grid) {
                    ...
                    const ACHIEVEMENTS_DATA = [
                        { id: "init", icon: '<img src="img/achievements/init.png" class="achievement-icon-img" alt="init">', color: "#D4B85A"  },
                        { id: "early", icon: '<img src="img/achievements/early.png" class="achievement-icon-img" alt="early">', color: "#8E6DA3"  },
                        { id: "night", icon: '<img src="img/achievements/night.png" class="achievement-icon-img" alt="night">', color: "#54789B"  },
                        { id: "fifty", icon: '<img src="img/achievements/fifty.png" class="achievement-icon-img" alt="fifty">', color: "#C06C4C"  },
                        { id: "moon", icon: '<img src="img/achievements/moon.png" class="achievement-icon-img" alt="moon">', color: "#A2A2A2"  },
                        { id: "alchemist", icon: '<img src="img/achievements/alchemist.png" class="achievement-icon-img" alt="alchemist">', color: "#4E876A"  },
                        { id: "compassive", icon: '<img src="img/achievements/compassive.png" class="achievement-icon-img" alt="compassive">', color: "#D4B85A"  },
                        { id: "grateful", icon: '<img src="img/achievements/grateful.png" class="achievement-icon-img" alt="grateful">', color: "#8E6DA3"  },
                        { id: "sincere", icon: '<img src="img/achievements/sincere.png" class="achievement-icon-img" alt="sincere">', color: "#54789B"  },
                        { id: "humble", icon: '<img src="img/achievements/humble.png" class="achievement-icon-img" alt="humble">', color: "#C06C4C"  }
                    ];
